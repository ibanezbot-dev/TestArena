        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-purple-400">{exam?.time_per_question}s</p>
              <p className="text-xs text-gray-500">por pregunta</p>
            </div>
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-blue-400">{exam?.num_questions}</p>
          ...
          {isHost && (
            <motion.button
              ...
              className="w-full bg-green-600 hover:bg-green-500 disabled:bg-gray-700 disabled:text-gray-500 text-white font-bold py-4 rounded-2xl text-lg transition-colors flex items-center justify-center gap-2 animate-pulse-glow"
            >
              {starting ? (
                ...
                <>
                  <Play size={24} />
                  Iniciar Examen ({participants.length} participantes)
                </>
              )}
            </motion.button>
          )}
